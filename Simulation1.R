...
#####################################Figure
par(mfrow=c(2,3))
plot(x=lambda, y=num1[1, ], pch=2, col=3, type="b", ylim=c(10,40), xlab = "lambda",ylab ="number of change points",main="h=15/n")
lines(x=lambda, y=NUM1[1, ], col=2, type="b")
legend("topright", legend=c("screening","multiple testing"), pch=c(2,1), col=c(3,2), bty="n")
plot(x=lambda, y=num1[2, ], pch=2, col=3, type="b", ylim=c(10,40), xlab = "lambda",ylab ="number of change points",main="h=18/n")
lines(x=lambda, y=NUM1[2, ], col=2, type="b")
legend("topright", legend=c("screening","multiple testing"), pch=c(2,1), col=c(3,2), bty="n")
plot(x=lambda, y=num1[3, ], pch=2, col=3, type="b", ylim=c(10,40), xlab = "lambda",ylab ="number of change points",main="h=21/n")
lines(x=lambda, y=NUM1[3, ], col=2, type="b")
legend("topright", legend=c("screening","multiple testing"), pch=c(2,1), col=c(3,2), bty="n")

plot(x=lambda, y=num2[1, ], pch=2, col=3, type="b", ylim=c(10,40), xlab = "lambda",ylab ="number of change points",main="h=15/n")
lines(x=lambda, y=NUM2[1, ], col=2, type="b")
legend("topright", legend=c("screening","multiple testing"), pch=c(2,1), col=c(3,2), bty="n")
plot(x=lambda, y=num2[2, ], pch=2, col=3, type="b", ylim=c(10,40), xlab = "lambda",ylab ="number of change points",main="h=18/n")
lines(x=lambda, y=NUM2[2, ], col=2, type="b")
legend("topright", legend=c("screening","multiple testing"), pch=c(2,1), col=c(3,2), bty="n")
plot(x=lambda, y=num2[3, ], pch=2, col=3, type="b", ylim=c(10,40), xlab = "lambda",ylab ="number of change points",main="h=21/n")
lines(x=lambda, y=NUM2[3, ], col=2, type="b")
legend("topright", legend=c("screening","multiple testing"), pch=c(2,1), col=c(3,2), bty="n")

######################################Table
rbind(cbind(NUM1[,1],FDP1[,1],NUM1[,2],FDP1[,2],NUM1[,3],FDP1[,3],NUM1[,4],FDP1[,4]), 
      cbind(NUM2[,1],FDP2[,1],NUM2[,2],FDP2[,2],NUM2[,3],FDP2[,3],NUM2[,4],FDP2[,4]))
